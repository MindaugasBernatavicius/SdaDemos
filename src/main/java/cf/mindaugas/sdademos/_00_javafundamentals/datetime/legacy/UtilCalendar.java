package cf.mindaugas.sdademos._00_javafundamentals.datetime.legacy;
...
public class UtilCalendar {
    public static void main(String[] args) {
        ...
        System.out.println("20 hours later: " + cal.getTime());
        ...
        System.out.println("Timezone " + cal.getTimeZone().getDisplayName()); // Timezone Eastern European Time
