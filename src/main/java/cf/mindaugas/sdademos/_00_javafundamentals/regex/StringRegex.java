package cf.mindaugas.sdademos._00_javafundamentals.regex;
...
public class StringRegex {
    ...
    public static void main(String[] args) {
        ...
        String paragraph = "This is is a sentence. Is this also a sentece? This as well! And the last one, I promise.";
        // String[] sentence = paragraph.split("\\.\\s|!\\s|\\?\\s");
