package cf.mindaugas.sdademos._05_jdbchibernatemongodriver.jdbc._5_blobandclob;
...
public class DBUtil {
    ...
    private static final String mySQLCS = "jdbc:mysql://localhost:3306/jdbcdemo?useUnicode=yes&characterEncoding=UTF-8";
