package cf.mindaugas.sdademos.design._02_patterns._01_creational._02_builder.sda;

import cf.mindaugas.sdademos.design._02_patterns._01_creational._02_builder.sda.example.Pizza;

public class Builder {

    public static void main(String[] args) {
        Pizza margharita = new Pizza.PizzaBuilder("Margharita", 50)
                .addChees(true).addSauce(true).takeaway(true).build();
        Pizza capriciosa = new Pizza.PizzaBuilder("Capriciosa", 42)
                .addChees(true).addSauce(false).takeaway(false).build();
