package cf.mindaugas.sdademos.javafundamentals.datetime.newjavatime;
...
public class TimeLocalDateTime {
    ...
    public static void main(String[] args) {
        ...
        // now.plusDays(1) -- this returns an object of LocalDateTime
        // so if we do not use it after it is returned, no addition happens
        now = now.plusDays(1);
        System.out.println(now);
