...
// TODO :: use the 'i' index to create a table || No. || Name || Surname ||;
$("#table-from-json-button").click(function(){
    $.ajax({
        url: "http://www.mocky.io/v2/5d026c4b3100002900ab2f7e",
        success: function(result){
...
// TODO :: add additional rows to the table using mocky (or you can use Spark framework if you are confident);
